...
document.getElementById('btn-withdraw').addEventListener('click', function(){
    ...
    const remainingBalance = parseFloat((document.getElementById('total-amount')).innerHTML);
   
   

    if((withdrawCurrent <= remainingBalance) && (withdrawCurrent != 0) && !isNaN(withdrawCurrent))
    {
